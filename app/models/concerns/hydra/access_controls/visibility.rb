  ...
  module Visibility
    ...
    def visibility=(value)
      ...
      when AccessRight::VISIBILITY_TEXT_VALUE_PRIVATE
        private_visibility!
      when AccessRight::VISIBILITY_TEXT_VALUE_IP
        ip_visibility!
      else
    ...
    def visibility
      ...
      elsif read_groups.include? AccessRight::PERMISSION_TEXT_VALUE_IP
        AccessRight::VISIBILITY_TEXT_VALUE_IP
      else
    ...
    private
      ...
      def ip_visibility!
        visibility_will_change! unless visibility == AccessRight::VISIBILITY_TEXT_VALUE_IP
        remove_groups = represented_visibility - [AccessRight::PERMISSION_TEXT_VALUE_IP]
        set_read_groups([AccessRight::PERMISSION_TEXT_VALUE_IP], remove_groups)
      end
