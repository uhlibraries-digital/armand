module Hydra
  module AccessControls
    class AccessRight
      ...
      PERMISSION_TEXT_VALUE_IP = 'ip'.freeze
      ...
      VISIBILITY_TEXT_VALUE_IP = 'ip'.freeze
      ...
      def open_access_with_ip?
        return false unless permissionable_is_ip?
        return true if has_visibility_text_for?(VISIBILITY_TEXT_VALUE_IP)
        permissionable.ip_address.present?
      end
